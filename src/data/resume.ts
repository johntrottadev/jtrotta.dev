  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "Built an AI call-monitoring and compliance platform: sentiment grading and automatic verification of required legal disclosures and consent, replacing manual spot-checks with full-coverage review and removing a large amount of recurring manual work.",
